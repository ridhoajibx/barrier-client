  ...
  return (
    <li className="relative">
      <button
        ...
        className="relative flex h-8.5 w-8.5 items-center justify-center rounded-full hover:text-gray-5 text-gray-6">
        ...
        <ul className="flex h-auto flex-col overflow-y-auto">
          <li>
            <button
              ...
              className="text-left flex flex-col gap-2.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 ">
              <p className="text-sm">
