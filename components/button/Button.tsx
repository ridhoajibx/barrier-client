...
const Button = (props: Props) => {
  ...
  const secondaryOutline = "border border-gray-4 text-secondary";
  ...
  useEffect(() => {
    ...
    else if (variant === "primary-outline-none")
      setVariants(primaryOutlineNone);
    else if (variant === "secondary") setVariants(secondary);
    else if (variant === "secondary-outline") setVariants(secondaryOutline);
    else if (variant === "secondary-outline-none")
      setVariants(secondaryOutlineNone);
